...
* **Compact Token Representation**: Programmatic intent and multi-level layout sweeps are represented as pure, lightweight text strings, eliminating monolithic CAD meshes and enabling stateless URL sharing.
