...
let generateHynteractPayload (str: string) (seq: Sqn) (ouStr: string) (ilStr: string) (enStr: string) (initialOcc : Hxl[]) = 
    ...
    let finalBatch, _, _ = Parsing.generateMultiLevelLayout str enStr initialOcc (Some seq) (Some ouStr) (Some ilStr)
...
let generateDataset (fullStr: string) (ouStr: string) (ilStr: string) (enStr: string) =
    ...
    |> Array.collect (fun sqn ->
        ...
        try
            ...
            let cxls, _, _ = Parsing.generateMultiLevelLayout forcedStr enStr [||] (Some sqn) (Some ouStr) (Some ilStr)
