...
// Default Syntax
let emptyState = "L0(Q=VRCCNE/L=0/X=1/B=0/E=0)(1/75/Root)"
...
let stackedTower = "L0(Q=VRCCNE/L=0/W=30/H=30/X=1/E=0/B=0/O=/I=)(1/75/Lobby)(1.1/88/Retail)(1.2/54/Toilets)(1.3/67/Retail)(1.4/94/Retail)" +
