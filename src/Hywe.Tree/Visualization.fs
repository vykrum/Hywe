/// <summary>
/// Tree visualization layout, geometric bounds calculation, and standalone SVG generation.
/// </summary>
...
/// <summary>
/// SVG graphic primitives for rendering tree nodes, connecting lines, and text labels.
/// </summary>
type VisualElement =
...
/// <summary>
/// Calculates the total width and height required to render a tree layout with standard margins.
/// </summary>
...
/// <summary>
/// Generates visual primitives (lines, polygons, text) and viewBox bounds for rendering a tree.
/// </summary>
...
/// <summary>
/// Renders a hierarchical tree into a self-contained SVG markup string.
/// </summary>
