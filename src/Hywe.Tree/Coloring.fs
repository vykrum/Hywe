/// <summary>
/// Node color generation, RGB transformations, and action-state highlighting for tree nodes.
/// </summary>
module Coloring
...
/// <summary> Converts a hexadecimal color string into an RGB integer tuple. </summary>
...
/// <summary>
/// Generates deterministic pastel color variations from a base hex color and opacity.
/// </summary>
...
/// <summary> Resets tree nodes to default uncolored state (None). </summary>
let colorTree (root: TreeNode) : TreeNode =
    root |> mapTree (fun n -> { n with Color = None })

/// <summary>
/// Colors tree nodes according to action state: blue for elevated nodes,
/// green for nested nodes, and uncolored for standard nodes.
/// </summary>
