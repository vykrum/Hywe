/// <summary>
/// Node action definitions, applicability rules, and state transformation handlers
/// for tree operations (Delete, Elevate, Nest).
/// </summary>
module Actions
...
/// <summary> Action logic for deleting nodes or levels from the tree. </summary>
...
/// <summary>
/// Action logic for promoting a node into an anchor for a higher elevation level.
/// </summary>
...
/// <summary>
/// Action logic for creating a nested sub-tree anchored to a leaf node.
/// </summary>
let nestActionLogic = {
...
/// <summary> Registry containing all registered node action definitions. </summary>
let logicRegistry = [
    deleteActionLogic
    elevateActionLogic
    nestActionLogic
...
/// <summary> Resolves a node action logic definition by its unique ActionId. </summary>
